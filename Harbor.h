 ...
 *
 * Déclaration des fonctions liées à la classe Harbor
 ...
 *  La classe gère le port, instance unique (Singleton)
 *  Un fichier de log est généré afin de suivre l'activité du port dans "traffic.txt"
 * \author Charles Bong.
 * \date 27 Novembre 2014
 */
